...
datadir=data
# run_id=viridian-extra-site-exclude_zero_precision_$precision-mm_$mismatches-mhc_${max_hmm_cost}-mgs_${min_group_size}
# run_id=viridian-dynamic-precision-exp-hmm5
run_id="maskdel-v1-mm_${mismatches}-f500-mrm_${min_root_mutations}-mms_${max_mutations_per_sample}-rw_${retrospective_window}-mgs_${min_group_size}"
