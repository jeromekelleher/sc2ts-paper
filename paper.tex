...
version 3.8.5 \citep{Huson2012-ys}. See Figure~\ref{fig:cophlogeny_long} for the equivalent cophylogeny
for the Long ARG.}
\end{figure}
...
\caption{\label{fig:cophlogeny_long}Tanglegram equivalent to that in
Figure~{fig:cophlogeny}, but for the long ARG (i.e. subsampled to mid-2022). }
\end{figure}
