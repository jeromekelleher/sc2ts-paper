...
\subsection{Tree inference from HMM sample clusters}
...
\subsection{Parsimony increasing hueristics}
...
hueristics would likely be of benefit.
...
inference, we also excluded sequences if they had a ``bad'' quality control status
