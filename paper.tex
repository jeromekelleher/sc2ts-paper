...
One is densely sampled, and includes 1.27 million sequences
sampled up to June 30, 2021.
The second is more sparsely sampled,
...
Using the well-established and fully-featured \texttt{tskit} library,
...
full alignments, and extensive metadata---requires
58MB of storage,
...
detectability of recombination.
...
[FIXME say this better and add citation.]
Multiple recombinant lineages have successfully
established and spread to high frequency.

[PARA 2: recombination is hard to detect. Quick overview of state-of-the-art.
Finish with phylogeny-based method, RIPPLES.]
...
% By searching for genomes containing segments
...
% resulting in the patterns investigated.
