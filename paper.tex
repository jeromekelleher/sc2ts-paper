...
That said, we can approximately relate these probabilities to the coalescent in a population with constant effective population size ($N_e$), with recombination process which LS is approximating to guide intuition. We may consider the probability of mutation to represent the
