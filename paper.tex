...
XE lineage, which was originally defined on the basis of sequences from the UK and Ireland. The
...
This certainly represents the canonical XE recombinant lineage. The other recombination nodes
...
However, the most recently derived XE cluster, consisting
of two samples (one from Canada and one from England) may not be due to mislabelling: not
only does it contain an English sample but it has exactly the same breakpoint interval as
the canonical XE clade. It is possible that instead, this is a case where the \texttt{sc2ts} algorithm
...
Investigating examples of nested recombinant origins, and identifying which
...
\begin{tabular}{lllrl}
\toprule
Pango & Sc2ts inferred parents & Official Pango parents & $n$ & Other descendants \\
\midrule
\bfseries XA & B.1.1.7 + B.1.177.18 & B.1.1.7 + B.1.177 & 5 & – \\
\bfseries XAA & BA.1 + BA.2.9 & BA.1* + BA.2* & 8 & XAB:~38/48, XAG:~17/17, XU:~1/3, XQ:~2/12 \\
\bfseries XAC & BA.1.17.2 + BA.2.3 & BA.1* + BA.2* & 27 & – \\
\bfseries XAE & BA.1 + BA.2 & BA.1* + BA.2* & 9 & – \\
\bfseries XAG & BA.1 + BA.2.9 & BA.1* + BA.2* & 17 & XAB:~38/48, XAA:~8/8, XU:~1/3, XQ:~2/12 \\
\bfseries XF & AY.4 + BA.1 & B.1.617.2* + BA.1* & 2 & – \\
\bfseries XG & BA.1.17 + BA.2 & BA.1* + BA.2* & 32 & XAB:~1/48 \\
\bfseries XH & BA.1.20 + BA.2.9 & BA.1* + BA.2* & 11 & XAF:~34/35, B.1.1.529:~2, XE:~3/163 \\
\bfseries XK & BA.1.1.1 + BA.2 & BA.1* + BA.2* & 3 & – \\
\bfseries XL & BA.1.17.2 + BA.2 & BA.1* + BA.2* & 10 & XAB:~1/48, XU:~1/3 \\
\bfseries XR & BA.1.1 + BA.2 & BA.1.1* + BA.2* & 8 & XQ:~9/12, XAB:~2/48 \\
\bfseries XS & AY.36 + BA.1.1 & B.1.617.2* + BA.1.1* & 4 & – \\
\bfseries XT & BA.2.23 + Unknown & BA.1* + BA.2* & 1 & BA.2.23:~1 \\
\bfseries XV & BA.1.1 + BA.2 + Unknown & BA.1* + BA.2* & 1 & BA.2:~8 \\
\bfseries XW & BA.1.1.15 + BA.2 & BA.1* + BA.2* & 11 & XN:~2/13 \\
\bfseries XY & BA.1.1 + BA.2 & BA.1* + BA.2* & 6 & XAF:~1/35 \\
\bottomrule
\end{tabular}
...
Sc2ts inferred parents are based on imputed NextClade Pango lineages. Official parents
are taken from Pango designation alias key (TODO: explain the asterisks). The final column
list other inferred descendants of the originating recombination event, summarised
by NextClade Pango designation and sample count / total ARG count (total count in the ARG
is omitted for non-recombinant samples).
}
\end{sidewaystable}

\begin{sidewaystable}
\begin{tabular}{llp{1.5cm}llrl}
\toprule
Causal date & Breakpoint & Causal lineage & Causal strain & Sc2ts inferred parents & $n_{XE}$ & Other descendants \\
\midrule
2022-01-06 & \{10448-11537\} & XH & Denmark/DCGC-323778/2022 & BA.1.20 + BA.2.9 & 3 & XAF: 34/35, XH: 11/11, B.1.1.529: 2 \\
2022-02-11 & {10448-11537} & XE & England/MILK-3674F1A/2022 & BA.1.17.2 + BA.2 & 155 &  \\
2022-02-17 & \{17411-19955\} & XE & Turkey/HSGM-G2220/2022 & Unknown + BA.2 & 1 & B.1.1.529: 1 \\
2022-04-09 & \{9867-10198\} & XE & Belgium/ULG-25782/2022 & BA.1 + BA.2 & 3 &  \\
2022-04-20 & \{10448-11537\} & XE & Canada/BC-BCCDC-424071/2022 & BA.1.1.15 + Unknown & 2 &  \\
\bottomrule
\end{tabular}
...
on 2022/1/16;  see \url{https://github.com/cov-lineages/pango-designation/issues/454}).
