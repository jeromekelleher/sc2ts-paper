...
starts with an ``X''. We focus primarily on the Long ARG
...
The Long ARG contains 749 samples designated by Nextclade [CITATION] as Pango
...
In contrast, using the alternative GISAID designation process [CITATION], only
