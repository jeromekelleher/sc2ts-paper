...
Most recent common ancestor (MRCA) date for pairs of parents on either side
of a recombination breakpoint, as a function of the divergence time between parent
pairs. Breakpoints from recombination events caused by Pango designated recombinants
(XA, etc) are identified in orange. Larger symbols represent breakpoints from
recombination nodes which are ancestral to five or more samples.
Horizontal dotted lines show the four most common MRCA nodes; these
tend to be associated with major outbreaks and with many immediate children.
