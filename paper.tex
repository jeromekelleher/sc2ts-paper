...
In Figure~\ref{fig:multiple_origins_graph} we give the details of these multiple pango lineages, along with an example lineage subgraph. The  earliest descendant sample of each of these putative independent XD origination nodes has EPI\_ISL: 11222324 (dated 2022-02-26) for the left hand plot, and EPI\_ISL 8514045 (dated 2021-12-30) for the right hand one. These two samples differ by  Supplementary Figure~\ref{fig:pango_XD_gisaid_graph} shows the equivalent subgraph with sample identifiers and GISAID Pango labels, none of which are XD (there are no samples designated by GISAID as XD in the long ARG). 
