...
SARS-CoV2 shows little recombination, with recombination nodes accounting
for <0.3\% of our inferred ancestry (Table~\ref{tab:args}). As a result,
relationships between strains can often be adequately represented by a
single tree, particularly early in the pandemic, or when looking at
