...
\author[3$\star$]{Anastasia Ignatieva}
\author[1$\star$]{Yan Wong}
\author[2]{Katherine Eaton}
...
% ... genomic surveillance programs, predictive models for symptoms and severity, policy recommendations such as vaccine effectiveness and booster frequency, etc. (https://doi.org/10.1016/S1473-3099(22)00831-3)
Detection of new recombinant strains is challenging, with methods
[being a bit rubbish].
% ... with few methods that facilitate rapid and systematic (reproducible) classification .https://pha4ge.org/resource/identifying-sars-cov-2-recombinants/
...
% reduced frequency of breakpoint sequence motifs, or secondary structure. Sorry, I don't have a citation for this, just theories. The RIPPLES paper vaguely mentions "important mechanistic bias shapes the distribution of recombination events". But maybe we just don't know yet?
...
% ... Defining the groups is a highly subjective process, involving numerous manual steps that require subject matter expertise of the organism, that often use web sites as data sources which are difficult to version-control, and thus hinder reproducibility. The web paper by the PH4GE group is one of the best sources for the reality (and pain) of how it's done: https://pha4ge.org/resource/identifying-sars-cov-2-recombinants/
...
large range in divergence times among recombinant parents, with a broad
spread of times from about 10 to 80 weeks prior to the recombination event
and a minor additional peak of recombinants that diverged
${\sim}95$ weeks, corresponding to recombinants whose
parental common ancestor traces to early 2020. This latter group should
