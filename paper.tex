...
for more analyis on the patterns of mutations inferred.
...
(Section~\ref{sec:args}). For exampl, the Wide ARG
...
The NextStrain
trees consist of a relatively small set of SARS-CoV-2 genomes, which over the time period
of our ARGs are almost entirely restricted to non-recombinant lineages. 
To enable this comparison, we ``simplified''~\citep{Kelleher2018-xc} 
the ARGs to  retain only samples that are in a 
...
the left-most tree (covering the genome interval 0--64) in the Wide ARG; 
