...
is 1,685 bases (median 962); the length distribution is summarised in the
inset histogram in Figure~\ref{fig:breakpoint-distribution}.

Figure~\ref{fig:breakpoint-distribution} [ TODO what can we really say here?
Other than the boundaries happen to lie on gene breaks, not an awful lot I
think?]

% This isn't really true any more, is it?
