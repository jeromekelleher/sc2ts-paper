...
\caption{\label{fig:cophylogeny} DESCRIBE ME. See
Figure~\ref{fig:cophlogeny_long} for the equivalent cophylogeny
for the Long ARG.
}
\end{figure}
...
\caption{\label{fig:cophlogeny_long}Copyhlogeny for the Long ARG. MORE DETAIL.}
\end{figure}
