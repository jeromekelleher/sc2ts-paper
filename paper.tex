...
Figure~\ref{fig:pango_XA_gisaid_graph} (see supplementary file XXX to map tskID to EPI_ISL and strain name).
Note that GISAID Pango designations render XAG is monophyletic a
}
\end{sidewaysfigure}
